...
describe('POST /checkParameter', () => { // 테스트 수트
    it('responds check parameter success', done => { // 테스트 단위 : 파라미터 검증이 올바를 때
        const utterance = 12345;

        request(functions.config().service_url.crawling) // 테스트 하려는 기본 주소
            .post('/checkParameter') // 주소의 엔드포인트
    ...
    it('responds check parameter fail', done => { // 테스트 단위 : 파라미터 검증이 올바를 때
